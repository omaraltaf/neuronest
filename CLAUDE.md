...
**Next up: UX simplification.** All §5 features are built; the platform now has more surfaces than a tired parent can follow. The full UX evaluation and prioritized fix plan live in `UX_PLAN.md` (2026-07-04) — P1: rebuild dashboard as "Today" with a close-the-loop quick-log on the focus card; P2: one bottom tab bar replacing the three competing navigation systems; P3: universal quick-log. Read it before touching any parent-facing screen.
