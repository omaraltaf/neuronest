...
1. **Family calendar context** — week-ahead answers currently feed only next Monday's planning + one pre-event material; they should accumulate into a durable calendar/rhythm context every agent can reason over (recurring events, school schedule, seasonal changes).
