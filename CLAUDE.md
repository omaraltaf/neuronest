...
**Database (schema `neuronest`):** children, intake_sessions, child_profiles, plans, goals, app_state, documents, weekly_checkins, generated_content, session_logs, agent_state, notifications, story_images, milestones, weekly_focus.
